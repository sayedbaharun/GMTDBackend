 ...
 */
router.post('/process', authenticateMobile, async (req: MobileAuthRequest, res): Promise<void> => {
  try {
 ...
 */
router.post('/create-intent', authenticateMobile, async (req: MobileAuthRequest, res): Promise<void> => {
  try {
    const userId = req.userId!;
...
async function sendBookingConfirmation(booking: any, guestDetails: any) {
  try {
